...
#     / /   \ \
#    / /     \ \ 
#   / / AVNET \ \          http://avnet.me/ultra96-v2
#
# ----------------------------------------------------------------------------
# 
...
# 				2021 Aug 18 -- No pin changes, notes only
#                           -- Corrected LS Mezz Bank note to Bank 26
#                           -- Updated website URL
#                           -- Added additional Bank notes
#
#     IO standard for Bank 26 Vcco supply is fixed at 1.8V
#     IO standard for Bank 65 Vcco supply is fixed at 1.2V
#     IO standard for Bank 66 Vcco supply is fixed at 1.2V (tied to Bank 65)
# 
