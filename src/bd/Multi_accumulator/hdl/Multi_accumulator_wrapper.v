...
//Date        : Sat Feb 12 15:54:25 2022
//Host        : DESKTOP-Q4T850H running 64-bit major release  (build 9200)
//Command     : generate_target Multi_accumulator_wrapper.bd
//Design      : Multi_accumulator_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module Multi_accumulator_wrapper
   (BRAM_addr_sim,
    BRAM_out_AXI_0_addr,
    BRAM_out_AXI_0_clk,
    BRAM_out_AXI_0_din,
  ...
  input [31:0]BRAM_out_AXI_0_addr;
  ...
  input [31:0]BRAM_out_AXI_1_addr;
  ...
  input [31:0]BRAM_out_AXI_2_addr;
  ...
  input [31:0]BRAM_out_AXI_3_addr;
  ...
  Multi_accumulator Multi_accumulator_i
