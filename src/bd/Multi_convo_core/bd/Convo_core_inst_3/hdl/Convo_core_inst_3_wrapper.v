...
//Date        : Tue Feb 15 08:38:50 2022
//Host        : DESKTOP-Q4T850H running 64-bit major release  (build 9200)
//Command     : generate_target Convo_core_inst_3_wrapper.bd
//Design      : Convo_core_inst_3_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module Convo_core_inst_3_wrapper
   (BRAM_img_AXI_addr,
    BRAM_img_AXI_din,
    BRAM_img_AXI_dout,
    BRAM_img_AXI_en,
  ...
  input BRAM_img_sel;
  input [11:0]BRAM_weight_AXI_0_addr;
  ...
  input [11:0]BRAM_weight_AXI_1_addr;
  ...
  input [11:0]BRAM_weight_AXI_2_addr;
  ...
  input [11:0]BRAM_weight_AXI_3_addr;
  ...
  wire BRAM_img_sel;
  wire [11:0]BRAM_weight_AXI_0_addr;
  ...
  wire [11:0]BRAM_weight_AXI_1_addr;
  ...
  wire [11:0]BRAM_weight_AXI_2_addr;
  ...
  wire [11:0]BRAM_weight_AXI_3_addr;
  ...
  Convo_core_inst_3 Convo_core_inst_3_i
