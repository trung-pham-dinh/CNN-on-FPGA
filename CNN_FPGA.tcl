...
#
# Generated by Vivado on Mon Jan 24 09:54:24 +0700 2022
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/sim/Convo_core_sim.v"]"\
  ...
  set paths [list \
   [file normalize "$origin_dir/ip_repo/myip_1.0"] \
   [file normalize "$origin_dir/ip_repo/pmul_AXI_1.0"] \
   [file normalize "$origin_dir/ip_repo/ConvoFIFO_uut_AXI_1.0"] \
   [file normalize "$origin_dir/ip_repo/testPackageIP_1.0"] \
  ]
  foreach ipath $paths {
...
set_property -name "webtalk.xsim_launch_sim" -value "466" -objects $obj
